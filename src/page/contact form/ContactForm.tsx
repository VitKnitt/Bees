...
export default function ContactForm() {
  ...
  return (
    <form
      ...
      className="form  bg-secondary md:w-[80%] m-auto my-10 md:rounded-xl border-4 border-tercialy"
    >
      <h2 className="qform">Dotazovací formulář</h2>

      {/* Jméno */}
      <div>
        <label htmlFor="jmeno" className="label">
          Jméno
        </label>
        <input
          type="text"
      ...
      {/* Příjmení */}
      <div>
        <label htmlFor="prijmeni" className="label">
          Příjmení
        </label>
        <input
          type="text"
      ...
      {/* Dotaz */}
      <div>
        <label htmlFor="dotaz" className="label">
          Dotaz
        </label>
        <textarea
          id="dotaz"
          ...
          rows={4}
          required
          placeholder="Rád/a bych obdržel/a PDF s vaší aktuální nabídkou medů."
          className="textArea"
        />
      </div>
