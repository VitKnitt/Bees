...
export function AboutUsText() {
  return (
    <article className="max-w-prose">
      <p>Včelí poklady</p>
      <h2 className="md:text-3xl lg:text-5xl text-tercialy pb-4 text-secondaryFont font-bold mb-3 border-b-4 border-tercialy">
        Objevte kouzlo přírodních produktů
      </h2>
